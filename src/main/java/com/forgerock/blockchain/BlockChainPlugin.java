 ...
 * available via Guice dependency injection. For forgerock, if you want to add an SMS service on install, you
 ...
 * }
 * </code></pre>
 * So that you can use the addSmsService api to load your schema XML for forgerock.
 ...
 * @since AM 5.5.0
 */
public class BlockChainPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(BlockChainPlugin.currentVersion, 
				Collections.singletonList(BlockChain.class));
	}
	...
	public String getPluginVersion() {
		return BlockChainPlugin.currentVersion;
	}
}
